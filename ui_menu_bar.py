...
from ui_menu_pulldown_item import FileMenuData, EditMenuData, ToolMenuData, ArtMenuData, FrameMenuData, LayerMenuData, CharColorMenuData, GameMenuData, HelpMenuData
